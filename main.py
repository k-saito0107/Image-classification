...
train_images=ImageFolder(
    '/Img-classification/Img_classification/data/Images/',
    transform=transform
)

test_images=ImageFolder(
    '/Img-classification/Img_classification/data/Annotations/',
    transform=transform
)
...
torch.save(up_model.state_dict(),'/Img-classification/Img_classification/weights/resnet'+str(num_epoch)+'.pth')
